...
export function calculatePoints(activities) {
  ...
  activities.forEach(activity => {
    const basePoints = POINTS_CONFIG.activities[activity.type] || POINTS_CONFIG.activities.default
    const multiplier = POINTS_CONFIG.status_multipliers[activity.status] || 0
...
export function getPointsForActivityType(activityType) {
  return POINTS_CONFIG.activities[activityType] || POINTS_CONFIG.activities.default
}
